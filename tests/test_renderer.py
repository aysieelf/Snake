...
class RendererShould(unittest.TestCase):
    ...
    def test_renderer_rendersStartScreen_whenGameStateInStartScreen(self):
        ...
        with (patch("src.ui.renderer.draw_start_screen") as mock_draw_start_screen,
    ...
    def test_renderer_drawsBonusFood_whenBonusFoodActive(self):
        ...
        with (patch("src.ui.renderer.draw_start_screen"),
              patch.object(self.renderer, "_draw_snake"),
    ...
    def test_drawSnake_drawsSnakeBody(self):
        self.game_state.snake.get_snake_body_positions.return_value = [(0, 0), (1, 1), (2, 2)]

        with (patch("src.ui.renderer.create_rectangle") as mock_create_rectangle,
              patch.object(self.renderer, "_get_eyes_positions", return_value=((0, 0), (1, 1))),
    ...
    def test_getEyesPositions_returnsCorrectPositions_whenFacingRight(self):
        ...
        expected_left_eye = (head[0] + c.CELL_SIZE - c.EYE_DEPTH - c.EYE_SIZE,
                             head[1] - c.EYE_OFFSET_SIDE_FAR)
        expected_right_eye = (head[0] + c.CELL_SIZE - c.EYE_DEPTH - c.EYE_SIZE,
    ...
    def test_drawFood_drawsFood(self):
        ...
        with patch("src.ui.renderer.create_rectangle") as mock_create_rectangle:
            ...
            mock_create_rectangle.assert_called_once_with(self.screen, (255, 198, 214), 0, 0, 20, 20)

    def test_drawGameOver_drawsGameOverScreen(self):
        with (patch.object(self.renderer, "_draw_game_over_overlay") as mock_draw_game_over_overlay,
              patch.object(self.renderer, "_draw_game_over_text") as mock_draw_game_over_text,
    ...
    def test_drawGameOverText_createsAndDrawsText(self):
        with (patch("pygame.font.SysFont") as mock_font_class,
            ...
            mock_font_class.assert_called_once_with(c.GAME_OVER_FONT, c.GAME_OVER_FONT_SIZE)
